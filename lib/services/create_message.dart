...
class MessageCreationService {
  ...
  Future<void> initModel() async {
    ...
    _chatEngine = await nobodywho.Chat.fromPath(modelPath: model.path);
  }
  ...
  Future<String> generatePushNotification({
    ...
    return "Do you want to sweeten your break? 10% discount on breads at Gym Cook.";
  }
